...
const SecondSection = () => {
  return (    
    <div className='relative isolate overflow-hidden w-full flex flex-col justify-center items-center py-14 bg-white shadow-2xl shadow-slate-800'>
      ...
      <div
        className="flex flex-col w-full md:flex-row md:justify-between md:space-x-8 lg:w-3/4 text-base mb-20"
      >
        <div className="w-full space-y-4 p-4">
          ...
          <div className='flex justify-center gap-x-8'>
            ...
            <div className='flex items-center justify-center' >
              <LocationIcon />
              <div className="text-sm font-semibold text-[#272162] text-center">Université Euro-méditerranéenne <br/> de Fès</div>
            </div>
          </div>
        </div>
